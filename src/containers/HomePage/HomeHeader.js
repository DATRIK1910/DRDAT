                    ...
                    <div className="home-header-content">
                        ...
                        <div className="center-content">
                            ...
                            <div className="child-content">
                                ...
                                <div className="subs-title"><FormattedMessage id="home-header.outstanding doctor" /></div>
                        ...
                        <div className="right-content">
                            <div className="support" ><i className="fas fa-question-circle"></i><FormattedMessage id="home-header.supports" /></div>
                ...
                <div className="home-header-banner">
                    <div className="content-up">
                        ...
                        <div className="search">
                            ...
                            <input type="text" placeholder="Tìm bác sĩ giỏi" />
                        </div>
                    </div>
